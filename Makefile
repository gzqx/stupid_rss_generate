...
TO_INST_PM = stupid_rss_generator.pl
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '  Clone: '\''0.46'\''' >> META_new.yml
	$(NOECHO) $(ECHO) '  Getopt::Long: '\''2.54'\''' >> META_new.yml
	$(NOECHO) $(ECHO) '  HTML::TreeBuilder: '\''5.07'\''' >> META_new.yml
	$(NOECHO) $(ECHO) '  IO::Prompter: '\''0.005001'\''' >> META_new.yml
	$(NOECHO) $(ECHO) '  LWP::UserAgent: '\''6.76'\''' >> META_new.yml
	$(NOECHO) $(ECHO) '  Lingua::ZH::Numbers: '\''0.04'\''' >> META_new.yml
	$(NOECHO) $(ECHO) '  Time::Piece: '\''1.3401'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '         "requires" : {' >> META_new.json
	$(NOECHO) $(ECHO) '            "Clone" : "0.46",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Getopt::Long" : "2.54",' >> META_new.json
	$(NOECHO) $(ECHO) '            "HTML::TreeBuilder" : "5.07",' >> META_new.json
	$(NOECHO) $(ECHO) '            "IO::Prompter" : "0.005001",' >> META_new.json
	$(NOECHO) $(ECHO) '            "LWP::UserAgent" : "6.76",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Lingua::ZH::Numbers" : "0.04",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Time::Piece" : "1.3401",' >> META_new.json
	$(NOECHO) $(ECHO) '            "URI" : "5.27",' >> META_new.json
	$(NOECHO) $(ECHO) '            "XML::RSS" : "1.63",' >> META_new.json
	$(NOECHO) $(ECHO) '            "YAML::Tiny" : "1.74"' >> META_new.json
	$(NOECHO) $(ECHO) '         }' >> META_new.json
	$(NOECHO) $(ECHO) '      }' >> META_new.json
	$(NOECHO) $(ECHO) '   },' >> META_new.json
